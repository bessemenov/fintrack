...
public enum ErrorResultCode {
    ...
    END_DATE_INVALID("0010"),
    START_DATE_INVALID("0011"),
    WALLET_NOT_FOUND("0012"),
    INCOME_OR_EXPENSE_REQUIRED("0013"),
    INCOME_NOT_FOUND("0014"),
    EXPENSE_NOT_FOUND("0015"),
    DESCRIPTION_TOO_LONG("0016"),
    OLD_TRANSACTION_DATE("0017"),
    TAG_NOT_FOUND("0018");
